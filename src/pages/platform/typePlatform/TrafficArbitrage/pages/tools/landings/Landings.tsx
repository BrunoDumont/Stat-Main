...
import header_table_landing from "./header.table.landings";
import Modal from "@pages/platform/typePlatform/TrafficArbitrage/pages/tools/landings/Modal";
...
const Landings: React.FC = () => {
    ...
    return (
        <>
            <div>
                <span className="text-2xl font-bold">Управление лендингами</span>
            </div>
            <div>
                <Table
                    columns={columns}
