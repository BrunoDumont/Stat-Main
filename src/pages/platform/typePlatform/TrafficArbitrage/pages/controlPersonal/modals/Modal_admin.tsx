...
//types
import {IControlPerson, user_group, UserGroupType} from "../СontrolPersonal";
...
const ModalAdmin: React.FC<IModalAdmin> = ({show, showModal, user, refetch, type}) => {
            ...
            <form onSubmit={(e) => type === 'add' ? addUser(e) : updateUser(e)}>
                ...
                <div className="mt-4 border-b pb-4">
                    ...
                    <Selector
                        ...
                        options={Object.keys(user_group)
                            .map((key: keyof UserGroupType) => ({value: key, label: user_group[key]}))
                        }
                    />
                    ...
                    />
                    {
                        modalUser.group === 'CLIENT_TEAM_LEAD' && !loading && <>
                            ...
                            <Selector
                                ...
                                value={
                                    modalUser.children
                                        ? modalUser.children.map(el => ({value: el.id, label: el.username}))
                                        : []
                                }
                                onChange={(data) => {
                                ...
                                options={userSelector
                                    .filter(el => el.group === 'CLIENT_TRAFFIC_MANAGER')
                        ...
                        modalUser.group === 'CLIENT_TRAFFIC_MANAGER' && !listOffers.loading && <>
                            ...
                            <Selector
                                ...
                                options={offersSelector
                                    .filter(el => el.offerByUser.filter(offer => offer.user && offer.user.username === modalUser.username).length === 0)
